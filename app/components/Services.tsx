      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto bg-n-8/50 p-2 rounded-xl">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border border-n-1/10 md:left-1/2  lg:bottom-8 md:-translate-x-1/2 min-w-[400px]" />
          </div>
